 ...
 */
package gui.admin.updateProfilAdmin;
 ...
 * @author Asus
 */
public class UpdateProfilAdminController implements Initializable {
...
//                get id and idRole for current user
            ...
            Logger.getLogger(UpdateProfilAdminController.class.getName()).log(Level.SEVERE, null, ex);
        }
